  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="reservedCars.php" class="nav-link">Reserved Cars</a></li>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('../images/bg_3.jpg');" data-stellar-background-ratio="0.5">
      ...
      <!-- <form action="#" method="POST" class="mb-5 p-4 bg-white shadow-sm rounded" style="border: 1px solid #ddd;">
			...
			<?php
                $id = $_SESSION['UserID'];
                $cquery = "SELECT * FROM reservation inner join cars on reservation.CAR_ID = cars.CAR_ID where reservation.CUS_ID='$id' and reservation.RES_STATUS='Reserved'";
              ...
              ?>
    			          <div class="col-md-4">
    			          	<div class="car-wrap rounded ftco-animate">
    			          		<div class="img rounded d-flex align-items-end" style="background-image: url(../<?php echo $row[16]; ?>);">
    			          		</div>
    			          		<div class="text">
    			          			<h2 class="mb-0"><a href="../car-single.php?id=<?php echo $row[2]; ?>"><?php echo $row[6] . " " . $row[7]; ?></a></h2>
                                    <span class="cat">Pick up date: <?php echo $row[3]; ?></span>
    			          			<div class="d-flex mb-3">
	    		          				<span class="cat">Plate: <?php echo $row[9]; ?></span>
	    		          				<p class="price ml-auto">$<?php echo $row[10]; ?><span>/day</span></p>
    			          			</div>
					          		<p class="d-flex mb-0 d-block"><a href="<?php if(isset($_SESSION['User']) && $_SESSION['User_type'] == "Customer"){echo "updateReservation.php?id=" . $row[0];}else{echo "login.php";}?>" class="btn btn-primary py-2 mr-1">Update</a><a href="<?php if(isset($_SESSION['User']) && $_SESSION['User_type'] == "Customer"){echo "cancelReserve.php?id=" . $row[0] . "&cid=" . $row[2];}else{echo "login.php";}?>" class="btn btn-danger py-2 mr-1">Cancel</a></p>
					          	</div>
    			          	</div>
    			          </div>
				<?php
