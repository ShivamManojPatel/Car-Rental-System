        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="reservedCars.php" style='color: black;'>Reserved cars</a>
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                    ...
                    <div class="container-fluid" style='padding-left: 5%; padding-right: 5%;'>
                        <center><h1 class="mt-4">Reserved Cars</h1></center>
                        ...
                        <div class="container">
                            <div class="row">
                                <?php
                                    $aquery = "SELECT * FROM reservation inner join cars on reservation.CAR_ID = cars.CAR_ID where reservation.RES_STATUS='Reserved'";
                                ...
                                ?>
                                        <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                                            ...
                                            <img src="../<?php echo $row[16]; ?>" class="card-img-top" alt="Mercedes Grand Sedan">
                                                <div class="card-body text">
                                                    <h5 class="mb-0"><a href="#"><?php echo $row[6] . " " . $row[7]; ?></a></h2>
                                                    <span class="cat">Pick up date: <?php echo $row[3]; ?></span><br>
                                                    <div class="d-flex mb-3">
                                                        <span class="cat">Plate: <?php echo $row[9]; ?></span>
                                                        <p class="price ml-auto">$<?php echo $row[10]; ?><span>/day</span></p>
                                                    </div>
                                                    <p class="d-flex mb-0 d-block"><a href="backDate.php?rid=<?php echo $row[0]; ?>&cid=<?php echo $row[2]; ?>" class="btn btn-success py-2 mr-1" style="width: 100%;">Mark Picked Up</a></p>
                                                </div>
                                            </div>
                                        </div>
                                <?php
                                        ...
                                        ?>
                                        <div class="col-md-12">
                                            <center><h3 class='mt-4'>No reserved vehicle</h3></center>
                                        </div>
                                        <?php
                                    }
                                ?>
