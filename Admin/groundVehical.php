        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="groundVehical.php" style='color: black;'>Grounded vehical</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                    ...
                    <div class="container-fluid" style='padding-left: 5%; padding-right: 5%;'>
                        <center><h1 class="mt-4">Grounded Cars</h1></center>
                        ...
                        <div class="container">
                            <div class="row">
                                <?php
                                    $aquery = "select * from cars where CAR_STATUS='Ground'";
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                                            <div class="card h-100">
                                                ...
                                                <div class="card-body text">
                                                    ...
                                                    <p class="d-flex mb-0 d-block"><a href="AvailableVehicalCode.php?id=<?php echo $row[0]; ?>" class="btn btn-success py-2 mr-1" style="width: 100%;">Make Available</a></p>
                                                </div>
                                            </div>
                                        </div>
                                <?php
                                        ...
                                        ?>
                                        <div class="col-md-12">
                                            <center><h3 class='mt-4'>No grounded vehicle</h3></center>
                                        </div>
                                        <?php
                                    }
                                ?>
