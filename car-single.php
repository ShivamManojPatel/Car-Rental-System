      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url(<?php echo $row[11]; ?>);"></div>
      				<div class="text text-center">
      					<span class="subheading"><?php echo $row[3]; ?></span>
              ...
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	              	...
	              	<div class="text">
		                <h3 class="heading mb-0 pl-3">
		                	Seats
		                	<span><?php echo $row[9]; ?> Adults</span>
		                </h3>
	                </div>
                </div>
              </div>
              ...
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	              	...
	              	<div class="text">
		                <h3 class="heading mb-0 pl-3">
		                	Luggage
		                	<span><?php echo $row[10]; ?> Bags</span>
		                </h3>
	                </div>
                </div>
              </div>
